...
describe('<NotificationsStorage>', function () {
    ...
    beforeEach(async () => {
        ...
        try {
            await db.dropCollection(storage.taksCollection);
        } catch (e) { /* surpress */ }
        try {
            await db.dropCollection(storage.campaignsCollection);
        } catch (e) { /* surpress */ }
        try {
            await db.dropCollection(storage.subscribtionsCollection);
        } catch (e) { /* surpress */ }
    });
